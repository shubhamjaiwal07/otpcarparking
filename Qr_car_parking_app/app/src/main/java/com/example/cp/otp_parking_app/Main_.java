...
public class Main_ extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnV = (Button) findViewById(R.id.btnViewP);
        ...
        Button btnQ = (Button) findViewById(R.id.btnViewQ);
        btnQ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Intent intent=new Intent(Main_.this,View_Otp.class);
                // startActivity(intent);
                Check_Book_info();
            }
        });

        Button btnTrans=(Button)findViewById(R.id.btnViewTransac);
        ...
        txtBal.setText(Cust_data.getBal());
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        try
        {
            ...
            inflater.inflate(R.menu.view_qr, menu);
            return true;
        }
        catch(Exception ex)
        {
